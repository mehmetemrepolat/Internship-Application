                        ...
                        <div class="card-body p-0">
                            <div class="d-flex align-items-center auth-content">
                                <div class="col-lg-6 bg-primary content-left">
                                    <div class="p-3">
                                        <h2 class="mb-2 text-white">Admin Giriş</h2>
                                        ...
                                        <form name="student_login" method="post">
                                            ...
                                            if($_POST)
                                            {
                                                ...
                                                $sqlProfileInfoQuery = "SELECT * FROM admin where Admin_Mail='$mail' and Admin_Password = '$password'";
                                                ...
                                                if ($count == 1)
                                                {
                                                    ...
                                                    header("location:admin-profile.php"); //sayfa yönlendirme

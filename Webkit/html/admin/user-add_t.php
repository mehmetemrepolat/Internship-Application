                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4"
                                      ...
                                      <div class="caption ml-3">
                                          <h6 class="mb-0 line-height"><?php echo $_SESSION["admin_mail"];?><i class="las la-angle-down ml-2"></i></h6>
                                      </div>
                                  </a>                            
                  ...
                  <div class="card">
                     <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h4 class="card-title">Yeni Öğretmen Ekle</h4>
                        </div>
                     </div>
                  </div>
            </div>
            <div class="col-xl-9 col-lg-8">
                <form name="ekleme_formu">
                  <div class="card">
                     <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h4 class="card-title">Öğretmen Bilgileri</h4>
                        </div>
                     </div>
                     <div class="card-body">
                        <div class="new-user-info">
                           <form name="ekleme" method="post">
                              <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                    <label for="add1">Öğretmen Numarası:</label>
                                    <input type="text" formmethod="post" class="form-control" id="add1" name="no" placeholder="Numara">
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label for="add2">Komisyon Üyeliği 0<->1:</label>
                                    <input type="text" formmethod="post" class="form-control" id="add2" name="comisyonmember" placeholder="Komisyon Üyeliği">
                                 </div>
                              ...
                              <button type="submit" formmethod="post"  class="btn btn-primary" ID="btnKayit">Kullanıcı Ekle</button>
                               ...
                               if ($_POST) {
                                   ...
                                   $ogretmen_no = $_REQUEST['no'];
                                   $mail_adress = $_REQUEST['mail_adress'];
                                   $komisyon = $_REQUEST['comisyonmember'];
                                   $temp_pass = password_hash(123, PASSWORD_DEFAULT);

                                  $sql_query = "
                                                INSERT INTO teachers_informations (Teacher_Number, Teacher_Name, Teacher_SurName, commission_memberShip, Teacher_mail, Teacher_password)
                                                VALUES ('$ogretmen_no', '$first_name', '$last_name', '$komisyon', '$mail_adress', '123');
                                                ";
